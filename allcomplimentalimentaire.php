...
<body>
    ...
    <section class="home">
        ...
        <div class="content-body">
            ...
            <main>
                <form action="addcomplimentalimentaire.php" method="post" enctype="multipart/form-data">
                    <div class='container'>
                        <div class='row'>
                            <?php 
                            include("config.php");
                            ...
                            ?>
                                <div class='col-md-4 mb-3'>
                                    ...
                                    <div class='card h-100 d-flex flex-column'>
                                        <img src='<?php echo $row['image']; ?>' class='card-img-top' alt='Image du compliment_alimentaire_name'>
                                        <div class='card-body'>
                                        ...
                                        <div class='card-footer d-flex justify-content-between'>
                                            <a href='editcomplimentalimentaire.php?id_compliment_alimentaire=<?php echo $row['id_compliment_alimentaire']; ?>' class='btn btn-primary'>Modifier</a>
                                            <a href='delet_compliment_alimentaire.php?id_compliment_alimentaire=<?php echo $row['id_compliment_alimentaire']; ?>' class='btn btn-danger'>Supprimer</a>
                                        </div>
                                    </div>
                                </div>
                            <?php
