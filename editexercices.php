...
if(isset($_GET["id_exercices"])) {
    ...
    $req = "SELECT * FROM exercices WHERE id_exercices = $id_exercices";
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Modifier Exercices</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active"><a href="#;">Exercices</a></li>
                    <li class="breadcrumb-item active"><a href="#;">Modifier Exercices</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                <div class="card">
                    ...
                    <form action="updateexercice.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_exercices" value="<?php echo isset($_GET['id_exercices']) ? $_GET['id_exercices'] : ''; ?>">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="exercice_name" class="form-label">Nom du Exercices</label>
                                <input type="text" class="form-control" name="exercice_name" value="<?php echo isset($data['exercice_name']) ? $data['exercice_name'] : ''; ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="file" name="video" required>
                            </div>
                            <button type="submit" class="btn btn-primary" name="Submit">Submit</button>
                            <a href="allexercices.php" class="btn btn-secondary">Annuler</a>
                        </div>
                    </form> 
                </div>
            </div>
