...
if(isset($_GET["id_compliment_alimentaire"])) {
    ...
    $req = "SELECT * FROM compliment_alimentaire WHERE id_compliment_alimentaire = $id_compliment_alimentaire";
    $up = mysqli_query($conn, $req);
            ...
            <div class="container">
                ...
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Modifier Compliment Alimentaire</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active"><a href="#;">Compliment Alimentaire</a></li>
                        <li class="breadcrumb-item active"><a href="#;">Modifier Compliment Alimentaire</a></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="col-xl-12 col-xxl-12 col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Compliment Alimentaire</h5>
                                </div>
                                <div class="card-body">
                                    <form action="updatecomplimentalimentaire.php" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id_compliment_alimentaire" value="<?php echo isset($_GET['id_compliment_alimentaire']) ? $_GET['id_compliment_alimentaire'] : ''; ?>">
                                        <div class="mb-3">
                                            <label for="compliment_alimentaire_name" class="form-label">Nom du Compliment Alimentaire</label>
                                            <input type="text" class="form-control" name="compliment_alimentaire_name" value="<?php echo isset($data['compliment_alimentaire_name']) ? $data['compliment_alimentaire_name'] : ''; ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="prix" class="form-label">prix</label>
                                            <input class="form-control" id="prix" name="prix" value="<?php echo isset($data['prix']) ? $data['prix'] : ''; ?>" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <a href="allcomplimentalimentaire.php" class="btn btn-secondary">Annuler</a>
                                    </form>
                                </div>
                            </div>
                        </div>
