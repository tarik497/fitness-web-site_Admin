...
if(isset($_GET["id_nutritions"])) {
    ...
    $req = "SELECT * FROM nutritions WHERE id_nutritions = $id_nutritions";
            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Modifier Nutrition</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active"><a href="#;">Nutrition</a></li>
                        <li class="breadcrumb-item active"><a href="#;">Modifier Nutrition</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="updatenutrition.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id_nutritions" value="<?php echo isset($_GET['id_nutritions']) ? $_GET['id_nutritions'] : ''; ?>">
                                <div class="mb-3">
                                    <label for="nutrition_name" class="form-label">Nom du nutrition</label>
                                    <input type="text" class="form-control"  name="nutrition_name" value="<?php echo isset($data['nutrition_name']) ? $data['nutrition_name'] : ''; ?>" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="file" name="video" accept="video/*" required>
                                </div>
                                <button type="submit" class="btn btn-primary" name="Submit">Submit</button>
                                <a href="allnutrition.php" class="btn btn-secondary">Annuler</a>
                            </form>
                        </div>
                    </div>
                </div>
